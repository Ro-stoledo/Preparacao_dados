...
-- Criação da tabela
CREATE TABLE SQL02.RST_campanha_marketing (
    id SERIAL,
...
CREATE OR REPLACE PROCEDURE SQL02.inserir_dados_campanha()
LANGUAGE plpgsql
AS $$
DECLARE
    i INT := 1;
...
BEGIN
    LOOP
        ...
        -- Inserir registro
        INSERT INTO SQL02.RST_campanha_marketing 
...
-- Executa a SP
call SQL02.inserir_dados_campanha();
