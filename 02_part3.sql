-- Verifica valores ausentes na tabela do schema SQL02
SELECT
...
FROM 
    SQL02.RST_campanha_marketing;


-- Cria o schema no banco de dados
CREATE SCHEMA SQL02 AUTHORIZATION RST;


-- Verifica valores ausentes no schema SQL02
SELECT
    COUNT(*) - COUNT(id) AS id_missing,
    COUNT(*) - COUNT(nome_campanha) AS nome_campanha_missing,
    COUNT(*) - COUNT(data_inicio) AS data_inicio_missing,
...
SELECT *
FROM SQL02.RST_campanha_marketing
...
DELETE FROM SQL02.RST_campanha_marketing
...
UPDATE SQL02.RST_campanha_marketing AS c
...
SELECT * FROM SQL02.RST_campanha_marketing;
...
ALTER TABLE SQL02.RST_campanha_marketing
...
UPDATE SQL02.RST_campanha_marketing
